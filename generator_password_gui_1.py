...
from tkinter import (Tk, Frame, Label, Entry, Button, mainloop, CENTER, messagebox, Radiobutton, IntVar, Checkbutton, W,
END)
...
class GUIPassword:
    ...
    def __init__(self):
        ...
        self.entry_2 = Entry(self.mid_frame_2, width=50, bg='white', justify=CENTER)
        ...
        self.mid_frame.pack()
        self.mid_frame_1.pack(anchor=W, padx=62, pady=(0, 5))
    ...
    def __generate_password(self, l):
        ...
        while count_letters < 1 or count_capital_letters < 1 or count_sym < 1 or count_num < 1:
            ...
            if (selection_capital_letters == 0 and selection_letters == 0 and
                    selection_symbols == 0 and selection_number == 0):
